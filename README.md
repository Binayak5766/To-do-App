This project contains a simple to-do app. This app just contains your daily chores and does not set any alarms to let you know. Those are things that are currently in development.
